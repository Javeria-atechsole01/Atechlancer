    ...
    const hireFreelancerCategories = [
        {
            ...
            items: ['Web Development', 'Mobile Development', 'Software Engineering', 'DevOps & Cloud', 'Data Science', 'Blockchain']
        },
        {
                                                ...
                                                <div key={idx} className="mega-menu-col">
                                                    ...
                                                    <ul>
                                                        {cat.items.map((item, i) => (
                                                            <li key={i}>
                                                                <Link to={`/gigs?category=${encodeURIComponent(item)}`} className="skill-item">
                                                                    {item}
                                                                </Link>
                                                            </li>
                                                        ))}
                            ...
                            {activeDropdown === 'm-hire' && (
                                <div className="mobile-sub-menu">
                                    {hireFreelancerCategories.map(cat => cat.items.map((item, i) => (
                                        <Link
                                            key={i}
                                            to={`/gigs?category=${encodeURIComponent(item)}`}
                                            className="navbar-mobile-link"
                                            style={{ fontSize: '0.9rem', border: 'none', padding: '0.5rem 0' }}
                                        >
                                            {item}
                                        </Link>
                                    )))}
